...
You can safely delete the following forms from your fresh install, if present (as of Textpattern v4.5 these forms were not part of the default theme):
...
h4. /forms/article.article_listing.txp
...
h4. /forms/article.search_results.txp
...
h4. /forms/comment.comment_form.txp
...
h4. /forms/comment.comments_display.txp
...
h4. /forms/comment.comments.txp

h4. /forms/comment.popup_comments.txp
...
h4. /forms/misc.search_input.txp
