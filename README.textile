h1. Textpattern CMS default theme (4.6 branch)
...
h3. Get the latest version of the theme

"Download from GitHub":https://github.com/philwareham/txp-h5bp-theme/archive/master.zip or use "Bower":http://bower.io:

bc. $ bower install txp-h5bp-theme
...
bc. <link rel="stylesheet" href="<txp:site_url />css/default.css">
...
h4. /css/default.min.css

Optional minified version of the 'default.css' file.

h4. /css/ie8.css

Internet Explorer 8 does not support media queries, so we provide an additional stylesheet to that browsers which forces the desktop (full width) layout. You can either copy/paste the whole stylesheet into admin area -> presentation -> style -> ie8 (you might need to create this stylesheet if it's not already in the CMS), and link as:
...
bc. <!--[if lt IE 9]>
  <script src="<txp:site_url />js/html5shiv.js"></script>
  <link rel="stylesheet" href="<txp:site_url />css/ie8.css">
<![endif]-->

h4. /css/ie8.min.css

Optional minified version of the 'ie8.css' file.
