...
Add the link to the external JavaScript file, as in this example above. Once the CSS and JavaScript files are in place, the code markup styling can be invoked via HTML or Textile (as of Textile v2.3 onwards).
