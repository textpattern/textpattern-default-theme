...
Place this entire directory into your root /js/ directory.

h4. /extra-options-non-core/code_prettify/prettify.txp

Add the link to the external JavaScript file, as in this example above. Once the CSS and JavaScript files are in place, the code markup styling can be invoked via HTML or Textile.

To invoke via HTML without line numbers:

bc. <pre class="prettyprint">...</pre>

To invoke via HTML without line numbers:

bc. <pre class="prettyprint linenums">...</pre>
