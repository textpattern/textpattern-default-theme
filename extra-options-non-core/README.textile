...
h3. Extra code option: footer-copyright

Add dynamically updated copyright statement to your page footers.

h4. /extra-options-non-core/footer-copyright/footer.txp

Paste the code into your current page templates, replacing the previous footer code. Note this code requires that you have 'Allow PHP in pages?' set to 'yes' in the Textpattern advanced preferences.

h3. Extra code option: google_plus
...
h3. Extra code option: twitter

Add a Twitter tweet button to each of your articles.

h4. /extra-options-non-core/twitter/twitter_tweet.txp

Paste the code from that form your default.article.txp form (around line 15 is recommended).