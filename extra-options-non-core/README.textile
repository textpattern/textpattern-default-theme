...
Google provides scripting to turn code within @<pre>@ tags into colour coded markup. It is recommended that you read the documentation before installation, which is available on the "Google Code Prettify project page":http://google-code-prettify.googlecode.com/svn/trunk/README.html.
