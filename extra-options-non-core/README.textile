...
Add a Google +1 button to each of your articles. Paste the code from that form your default.article.txp form (around line 15 is recommended). Note that we are loading this as asynchronous JavaScript so it does not delay page rendering.
...
Add a Twitter tweet button to each of your articles. Paste the code from that form your default.article.txp form (around line 15 is recommended).